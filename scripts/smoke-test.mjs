...
try {
  ...
  const requiredArchiveEntries = [
    ...
    "node_modules/@everyx/pi-status-line/tps.ts",
    "node_modules/@everyx/pi-status-line/LICENSE",
    "node_modules/@everyx/pi-status-line/package.json",
    ...
    "node_modules/pi-input-history/package.json",
    "node_modules/pi-input-history/index.ts",
    "node_modules/pi-input-history/LICENSE",
